...
import TotalRequest from './pro-blocks/total-request/index';
import ConsoleUsedChannels from './pro-blocks/used-channels/index';
import RequestByStages from './pro-blocks/request-by-stages/index';
import ConsoleUsedDevices from './pro-blocks/used-devices/index';
import { StateModel } from './pro-blocks/total-request/models/model';
import { StateModelChannels } from './pro-blocks/used-channels/models/model';
import { StateModelStage } from './pro-blocks/request-by-stages/models/model';
import { StateModelDevices } from './pro-blocks/used-devices/models/model';
