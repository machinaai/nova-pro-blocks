...
const UploadIne: React.FC<UploadIneProps> = ({
 ...
 // variable to save Upload Button component
  const uploadButton = (
    <div>
      <PlusOutlined />
      <div style={{ marginTop: 8 }}>{internationalization.formatMessage({ id: `BLOCK_NAME.upload.btn`})}</div>
    </div>
  );
        ...
        <div className={changeview ? styles.uploadContainerChange : null}>
          <div className={styles.firtsUpload}>
            <div className={styles.title}>
              {internationalization.formatMessage({ id: `BLOCK_NAME.ine.front`})}
            </div>
            <div>
              <Upload
                accept=".pdf, .png, .jpg"
          ...
          <div className={styles.secondUpload}>
            <div className={styles.title}>
            {internationalization.formatMessage({ id: `BLOCK_NAME.ine.back`})}
            </div>
            <div>
              <Upload
                accept=".pdf, .png, .jpg"
