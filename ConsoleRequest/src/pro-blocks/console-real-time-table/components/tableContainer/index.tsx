...
export const TableContainer: React.FC<PropsComponent> = ({ dataTable, valueFilter, valInputSearch='',action,extraCont}) => {
    ...
    if (valueFilter === 'documentation') {
        ...
        const extraContent = <div className={styles.extraCont}>
            ...
            />
            <p className={styles.titleExtraCont} style={{color:`${extraCont?.color}`,fontFamily:`${extraCont?.fontText}`}}>{intl.formatMessage({ id: 'BLOCK_NAME.title-extra-content1' })}</p>
        </div>
                ...
                },
                {
                    ...
                    extraContent: <div className={styles.extraCont}>
                        <BellFilled
                            ...
                            style={{color:`${extraCont?.color}`}}
                        />
                        <p className={styles.titleExtraCont} style={{color:`${extraCont?.color}`,fontFamily:`${extraCont?.fontText}`}}>{intl.formatMessage({ id: 'BLOCK_NAME.title-extra-content2' })}</p>
                    </div>
                },
            ]
        }
